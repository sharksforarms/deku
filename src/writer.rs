...
mod tests {
    ...
    fn test_bit_order() {
        ...
        writer
            ...
            .unwrap();
        writer.finalize();
        assert_eq!(out_buf, [0b1010_1001, 0b0101_0000]);
        ...
        writer
            ...
            .unwrap();
        writer.finalize();
        assert_eq!(out_buf, [0b110_1010, 0b0101_0000]);
        ...
        writer
            ...
            .unwrap();
        writer.finalize();
        assert_eq!(out_buf, [0b0101_0110, 0b1010_0000]);
    }
}
