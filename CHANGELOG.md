...
## [0.20.4](https://github.com/sharksforarms/deku/compare/deku-v0.20.3...deku-v0.20.4) - 2026-09-24
...
- Add bound attributes to restrict derived impls ([#685](https://github.com/sharksforarms/deku/pull/685))
- read and write a byte array in one call ([#684](https://github.com/sharksforarms/deku/pull/684))
- read and write a run of adjacent bit fields in one call ([#677](https://github.com/sharksforarms/deku/pull/677))
- Implement DekuContainerWrite on enums regardless of feature selection ([#681](https://github.com/sharksforarms/deku/pull/681))
